        ...
        <div className="p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <a href="#" className="font-medium text-bitfinex-blue hover:text-bitfinex-light-blue">
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-400">
              ...
              <Link to="/signup" className="text-bitfinex-blue font-medium hover:text-bitfinex-light-blue">
